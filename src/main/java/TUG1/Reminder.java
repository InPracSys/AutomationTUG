...
public class Reminder {
	  WebDriver driver;
	    ...
	    public Reminder(WebDriver driver) {
	        this.driver = driver;
	    ...
	    public void Reminderclick() throws InterruptedException {
	        WebElement Reminders = driver.findElement(By.xpath("//span[normalize-space()='REMINDERS']"));
	        Thread.sleep(3000);
	        Actions actions = new Actions(driver);
	        actions.moveToElement(Reminders).click().perform();
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("arguments[0].click();", Reminders);
	    }
}
